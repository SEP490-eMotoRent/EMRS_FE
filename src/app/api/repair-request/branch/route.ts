...
// GET /api/repair-request/branch - Lấy yêu cầu sửa chữa theo branch
export async function GET(req: Request) {
  try {
    ...
    const url = `${API_BASE}/RepairRequest/branch?${params.toString()}`;
    ...
    console.error("GET /api/repair-request/branch Error:", err);
    if (err.response) {
